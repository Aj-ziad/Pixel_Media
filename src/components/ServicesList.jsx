    ...
    <div className="flex flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8 font-sans mt-16">
      ...
      <div className="text-center max-w-2xl mb-12">
        ...
        <p className="text-base sm:text-lg md:text-xl text-gray-700">
          From stunning web design to powerful digital strategies, we provide comprehensive solutions to elevate your brand.
        </p>
      </div>
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="absolute top-3 left-3 bg-white text-[#ffb900] text-sm font-medium px-3 py-1 rounded-full shadow">
                {service.targetAudience || 'Service'}
              </div>
            ...
            {/* Details */}
            <div className="p-5">
              <h5 className="mb-2 text-lg font-bold text-gray-900">{service.title}</h5>
      ...
      {services.length > 3 && (
        <div className="mt-10">
          ...
          >
            {showAll ? 'Hide Services' : 'Show All Services'}
          </button>
        </div>
      )}
    </div>
